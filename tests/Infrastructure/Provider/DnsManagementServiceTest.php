...
final class DnsManagementServiceTest extends TestCase
{
    ...
    private function makeProvider(array $capabilities = []): DnsProviderInterface
    {
        ...
        return new class($caps) implements DnsProviderInterface {
            ...
            public function capabilities(): ProviderCapabilitySet { return new ProviderCapabilitySet($this->caps); }
            ...
            public function createRecord(Record $record): Record { return $record; }
