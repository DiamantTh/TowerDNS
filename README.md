...
Die Hauptseiten besitzen direkte PHP-Adressen wie `/index.php`, `/zones.php`,
`/records.php?account=107&zone=21` und `/profile.php`. Sie starten denselben
Mezzio-Anwendungskern; bisherige Pfadrouten bleiben erreichbar. Details zu
